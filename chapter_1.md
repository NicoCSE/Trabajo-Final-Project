...
| :--- | :--- |
| Las EPS y operadoras de residuos en Lima carecen de visibilidad en tiempo real de sus redes, resultando en: <br>• **Costos críticos:** Mantenimiento reactivo y multas de la OEFA (hasta S/ 128M).<br>• **Inseguridad:** Riesgos por gases tóxicos en ductos.<br>• **Desperdicio:** Solo se trata el 20% de aguas residuales en Lima, perdiendo el potencial de economía circular. | • **Eficiencia:** Reducción del 20% en salidas de cuadrillas de emergencia por obstrucciones.<br>• **Cumplimiento:** Cero infracciones por parámetros de PH fuera de norma.<br>• **Impacto Social:** Al menos 2 sectores vulnerables reciban agua recuperada en el primer semestre.<br>• **Seguridad:** 80% de adopción de la plataforma como EPP digital. |
| **3. Users & Customers** | **4. User Benefits** |
| • **Gerentes de Operaciones (EPS):** Eficiencia y prevención de sanciones.<br>• **Jefes de Cuadrilla:** Información accionable antes de un desborde.<br>• **Operadoras de Residuos:** Protección de cuencas (Rímac/Chillón) contra lixiviados.<br>• **Gobiernos Locales:** Data para Smart Cities. | • **Tranquilidad operativa:** Reducción de crisis por desbordes imprevistos.<br>• **Seguridad Física:** Alertas tempranas de gases antes de inspecciones físicas.<br>• **Reputación:** Validación de cumplimiento ambiental y sostenibilidad ante la comunidad. |
| **5. Solutions** | **6. Hypotheses** |
| • **Hardware IoT:** Sensores de PH, flujo y gases tóxicos.<br>• **App de Alertas:** Notificaciones push en tiempo real para campo.<br>• **Dashboard Predictivo:** Análisis de tendencias de contaminación.<br>• **Módulo Logístico:** Gestión de rutas para la redistribución de agua recuperada. | • Creemos que el monitoreo de flujo reducirá costos al detectar obstrucciones preventivamente.<br>• Creemos que la detección de gases aumentará la seguridad percibida por el trabajador.<br>• Creemos que la automatización logística creará una nueva línea de impacto social para las operadoras. |
| **7. What’s the most important thing we need to learn first?** | **8. What’s the least amount of work we need to do to learn that?** |
| ¿Están las empresas dispuestas a pagar la suscripción basándose en el ahorro proyectado? ¿La tecnología de los sensores resiste la corrosión y condiciones de los colectores de Lima? | • **Entrevistas de solución:** Presentar el Dashboard con datos simulados a jefes de planta.<br>• **Prueba de Humo (Smoke Test):** Landing page ofreciendo el "Plan Gestión Operativa" para medir interés de registro (CTR). |
...
- Cubren alrededor del 85–90% de la población urbana peruana, según datos de acceso al agua por red pública en el área urbana publicados por el Instituto Nacional de Estadística e Informática (INEI, 2023).
- En Lima Metropolitana se generan aproximadamente 1,2 millones de m³ de aguas residuales diariamente, de las cuales solo alrededor del 20% recibe tratamiento, según informes de la ANA y análisis académicos sobre saneamiento en Lima (ANA, 2025; PUCP, 2018).
